...
# 66 "/usr/include/x86_64-linux-gnu/sys/time.h"
...
Timer *timer_init() {
    ...
    if (timer_ptr->start_instant == ((void*)0)) {
        return ((void*)0);
    }
...
void timer_start(Timer *timer) {
    ...
    switch (timer->state) {
        ...
        case STOP:
            ...
            clock_gettime(1, timer->start_instant);
