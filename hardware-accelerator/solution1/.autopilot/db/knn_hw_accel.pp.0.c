# 1 "src/hardware-accelerator/knn_hw_accel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/hardware-accelerator/knn_hw_accel.c" 2
# 1 "src/hardware-accelerator/knn_hw_accel.h" 1


# 1 "src/hardware-accelerator/../types.h" 1




# 1 "src/hardware-accelerator/../params.h" 1



# 1 "/tools/Xilinx/Vitis_HLS/2023.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/float.h" 1 3
# 5 "src/hardware-accelerator/../params.h" 2
# 6 "src/hardware-accelerator/../types.h" 2
...
# 4 "src/hardware-accelerator/knn_hw_accel.h" 2

__attribute__((sdx_kernel("hw_get_eucledean_distances", 0))) void hw_get_eucledean_distances(Point new_point, double *points_features,
                                double *dist_points_distances);
# 2 "src/hardware-accelerator/knn_hw_accel.c" 2


__attribute__((sdx_kernel("hw_get_eucledean_distances", 0))) void hw_get_eucledean_distances(Point new_point, double *points_features,
                                double *dist_points_distances) {
#line 33 "/home/sirze/repos/CHE/hardware-accelerator/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=hw_get_eucledean_distances
# 5 "src/hardware-accelerator/knn_hw_accel.c"

#line 7 "/home/sirze/repos/CHE/hardware-accelerator/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=hw_get_eucledean_distances
# 5 "src/hardware-accelerator/knn_hw_accel.c"
    ...
    VITIS_LOOP_9_1: for (int i = 0; i < 4336; i++) {
        double diffs[43];
        int idx =
            i * 43;
        VITIS_LOOP_13_2: for (int j = 0; j < 43; j++) {
            double diff =
        ...
        double distance = 0.0;
        VITIS_LOOP_21_3: for(int j = 0; j < 43; j++){
         distance += diffs[j];
        }
